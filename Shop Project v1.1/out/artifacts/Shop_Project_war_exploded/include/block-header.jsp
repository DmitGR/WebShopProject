...
<%--
    ...
    <div id = "block-user">
        <ul>
            <li><img src="/img/userMINI.png"/> <a href='profile.jsp' id = 'profile-link'>Профиль</a></li>
    ...
    <img id = "img-logo2" src="/img/logo2.png"/>
    <!--Информационный блок-->
 <!--  <div id = "info"> -->
 ...
 <!--  </div>        -->
    ...
    <div id = "block-search">
        ...
        <!--Настроить метод поиска-->
            ...
            <input type="text" id = "input-search" autocomplete=false placeholder="Поиск по магазину">
